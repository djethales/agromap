        ...
        <div class="flex justify-between">
            <div class="w-9/12">
                <div class="px-8 h-full pt-10">
                    ...
                    <input type="text" class="appearance-none focus:outline-none w-full px-4 py-4" name="title" value=" {!! $post->title !!}">
                    <div class="py-6">
                        <textarea type="text" id="content" class="w-full appearance-none bg-transparent" name="content" rows="10">
                            {!! $post->content !!}
                        </textarea>
                    </div>
                </div>
            ...
            <div class="w-3/12 border-gray-200 border-l bg-white h-full">
                ...
                <div class="p-3">
                    <h3 class="font-rubik  text-xl text-gray-700 font-bold pb-3 ">{{__('Image a la une')}}</h3>
                    <div class="w-full img-une relative">

                        <img src="{{asset('imgposts/'. $post->image )}}">
